...
# irga_data <- read_csv(here::here('results/for_graphing.csv'))

##Load user functions (use function 'source' and the path to the .R file)

### LOAD FUNCTION SCRIPT ### 
source(here::here('src/shiny_functions_clean.R'))

####Shiny UI
ui <- dashboardPage(
    dashboardHeader(title = "IRGA: Lab macronutrients"),#This is the title of the shiny dashboard
